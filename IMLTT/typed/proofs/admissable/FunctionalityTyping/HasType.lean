       ...
       ((∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
         ...
         (∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
             ...
             (Γ_1 ⊢ s ≡ s' ∶ S) →
               (Γ_1 ⊢ s ∶ S) →
                 (Γ_1 ⊢ s' ∶ S) →
                   eqM ▸ Γ ⬝ B = Γ_1 ⬝ S ⊗ Δ ⊙ T ⊗ Ξ → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ T⌈s/ₙleq⌉ ≡ T⌈s'/ₙleq⌉ type) ∧
           ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (t T : Tm (m + 1))
             (eqM : x + 1 = m + 1),
             (Γ_1 ⊢ s ≡ s' ∶ S) →
               (Γ_1 ⊢ s ∶ S) →
        ...
        ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (t T : Tm (m + 1))
          ...
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
              (Γ_1 ⊢ s' ∶ S) →
                eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                  eqM ▸ 𝓏 = t → eqM ▸ 𝒩 = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉ :=
  by
    intro n Γ' hiC ihiC
    apply And.intro
    · intro m l k hleq Γ Δ Ξ heqM s s' S T hssS hsS hsS' heqΓ
        ...
        ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (t T : Tm (m + 1))
          ...
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
              (Γ_1 ⊢ s' ∶ S) →
                eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                  eqM ▸ x = t → eqM ▸ 𝒩 = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉) →
      (∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
          (eqM : n = k + 1) (s s' S : Tm l) (T : Tm (m + 1)),
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
        ...
        ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (t T : Tm (m + 1))
          ...
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
              (Γ_1 ⊢ s' ∶ S) →
                eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                  eqM ▸ 𝓈(x) = t → eqM ▸ 𝒩 = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉ :=
  by
        ...
        ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (t T : Tm (m + 1))
          ...
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
              (Γ_1 ⊢ s' ∶ S) →
                eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                  eqM ▸ 𝒩 = t → eqM ▸ 𝒰 = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉ :=
  by
    intro n Γ' hiC ihiC
    apply And.intro
    · intro m l k hleq Γ Δ Ξ heqM s s' S T hssS hsS hsS' heqΓ
     ...
     (Γ ⊢ b ∶ 𝟙) →
       ((∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
             ...
             (Γ_1 ⊢ s ≡ s' ∶ S) →
               (Γ_1 ⊢ s ∶ S) →
                 (Γ_1 ⊢ s' ∶ S) →
                   eqM ▸ Γ ⬝ 𝟙 = Γ_1 ⬝ S ⊗ Δ ⊙ T ⊗ Ξ → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ T⌈s/ₙleq⌉ ≡ T⌈s'/ₙleq⌉ type) ∧
           ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (T : Tm (m + 1))
             (eqM : n + 1 = m + 1),
             (Γ_1 ⊢ s ≡ s' ∶ S) →
               (Γ_1 ⊢ s ∶ S) →
   ...
   (Γ ⊢ b ∶ 𝟘) →
     ((∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
           ...
           (Γ_1 ⊢ s ≡ s' ∶ S) →
             (Γ_1 ⊢ s ∶ S) →
               (Γ_1 ⊢ s' ∶ S) →
                 eqM ▸ Γ ⬝ 𝟘 = Γ_1 ⬝ S ⊗ Δ ⊙ T ⊗ Ξ → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ T⌈s/ₙleq⌉ ≡ T⌈s'/ₙleq⌉ type) ∧
         ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (T : Tm (m + 1))
           (eqM : n + 1 = m + 1),
           (Γ_1 ⊢ s ≡ s' ∶ S) →
             (Γ_1 ⊢ s ∶ S) →
...
theorem functionality_typing_sigma_first :
        ...
        ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (t T : Tm (m + 1))
          ...
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
              (Γ_1 ⊢ s' ∶ S) →
                eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                  eqM ▸ p = t → (eqM ▸ ΣA;B) = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉) →
      (∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
          (eqM : n = k + 1) (s s' S : Tm l) (T : Tm (m + 1)),
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
        ...
        ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (t T : Tm (m + 1))
          ...
          (Γ_1 ⊢ s ≡ s' ∶ S) →
            (Γ_1 ⊢ s ∶ S) →
              (Γ_1 ⊢ s' ∶ S) →
                eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                  eqM ▸ π₁ p = t → eqM ▸ A = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉ :=
  by
...
theorem functionality_typing_sigma_second :
    ∀ {n : Nat} {Γ : Ctx n} {p A : Tm n} {B : Tm (n + 1)},
    (Γ ⊢ p ∶ ΣA;B) →
    ((∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
          (eqM : n = k + 1) (s s' S : Tm l) (T : Tm (m + 1)),
          ...
          (Γ ⊢ x ∶ 𝒩) →
            ((∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
                  ...
                  (Γ_1 ⊢ s ≡ s' ∶ S) →
                    (Γ_1 ⊢ s ∶ S) →
                      (Γ_1 ⊢ s' ∶ S) →
                        eqM ▸ Γ ⬝ 𝒩 = Γ_1 ⬝ S ⊗ Δ ⊙ T ⊗ Ξ → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ T⌈s/ₙleq⌉ ≡ T⌈s'/ₙleq⌉ type) ∧
                ∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (s s' S : Tm l) (T : Tm (m + 1))
                  (eqM : n + 1 = m + 1),
                  (Γ_1 ⊢ s ≡ s' ∶ S) →
                    (Γ_1 ⊢ s ∶ S) →
                    ...
                    (Γ_1 ⊢ s ≡ s' ∶ S) →
                      (Γ_1 ⊢ s ∶ S) →
                        (Γ_1 ⊢ s' ∶ S) →
                          eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                            eqM ▸ z = t →
                              eqM ▸ A⌈𝓏⌉₀ = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉) →
                ((∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
                        ...
                        (Γ_1 ⊢ s ≡ s' ∶ S) →
                          (Γ_1 ⊢ s ∶ S) →
                            (Γ_1 ⊢ s' ∶ S) →
                              eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                                eqM ▸ x = t →
                                  eqM ▸ 𝒩 = T → Γ_1 ⊗ ⌈s⌉(Δ w/Nat.le_refl l) ⊢ t⌈s/ₙleq⌉ ≡ t⌈s'/ₙleq⌉ ∶ T⌈s/ₙleq⌉) →
                    (∀ (m l k : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) (m + 1)) (Ξ : CtxGen (m + 2) (k + 1))
                        (eqM : n = k + 1) (s s' S : Tm l) (T : Tm (m + 1)),
                        (Γ_1 ⊢ s ≡ s' ∶ S) →
                          (Γ_1 ⊢ s ∶ S) →
