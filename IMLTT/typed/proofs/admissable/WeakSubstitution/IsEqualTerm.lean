...
theorem weak_substitutoin_sigma_first_comp :
          ...
          (∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1)) (S : Tm l)
            ...
            (∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1))
              ...
              (∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1))
                ...
                ∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1))
                  (S : Tm l) (a_7 a' A_1 : Tm m),
                  eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                    eqM ▸ π₁ a&b = a_7 →
                      eqM ▸ a = a' →
                        eqM ▸ A = A_1 →
                          (Γ_1 ⬝ S ⊢ s ∶ S⌊↑ₚidₚ⌋) →
                            Γ_1 ⬝ S ⊗ ⌈s↑⌉(Δ w/Nat.le_refl (l + 1)) ⊢ a_7⌈s↑/ₙleq⌉ ≡ a'⌈s↑/ₙleq⌉ ∶ A_1⌈s↑/ₙleq⌉ :=
  by
...
theorem weak_substitution_sigma_second_comp :
    ∀ {n : Nat} {Γ : Ctx n} {a b A : Tm n} {B : Tm (n + 1)},
    (Γ ⊢ a ∶ A) →
      (Γ ⊢ b ∶ B⌈a⌉₀) →
        Γ ⊢ ΣA;B type →
                  ...
                  eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                    eqM ▸ π₂ a&b = a_7 →
                      eqM ▸ b = a' →
                        eqM ▸ B⌈π₁ a&b⌉₀ = A →
                          (Γ_1 ⬝ S ⊢ s ∶ S⌊↑ₚidₚ⌋) →
                            Γ_1 ⬝ S ⊗ ⌈s↑⌉(Δ w/Nat.le_refl (l + 1)) ⊢ a_7⌈s↑/ₙleq⌉ ≡ a'⌈s↑/ₙleq⌉ ∶ A⌈s↑/ₙleq⌉ :=
  by
    intro n Γ' a b A B haA hbB hSi ihaA ihbB ihSi m l hleq Γ Δ heqM s S t t' T heqΓ heqt heqt' heqT hsS
    cases heqM
    cases heqΓ
...
theorem weak_susbtitution_nat_succ_comp :
                  ...
                  eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                    eqM ▸ b = a_6 →
                      eqM ▸ B⌈(ₛidₚ), a, a, A.refl a⌉ = A_1 →
                        (Γ_1 ⬝ S ⊢ s ∶ S⌊↑ₚidₚ⌋) →
                          Γ_1 ⬝ S ⊗ ⌈s↑⌉(Δ w/Nat.le_refl (l + 1)) ⊢ a_6⌈s↑/ₙleq⌉ ∶ A_1⌈s↑/ₙleq⌉) →
                (∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1))
                    (S : Tm l) (a_7 A_1 : Tm m),
                    eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                      eqM ▸ a = a_7 →
...
theorem weak_substitution_sigma_first_eq :
...
theorem weak_substitution_sigma_second_eq :
    ∀ {n : Nat} {Γ : Ctx n} {p p' A : Tm n} {B : Tm (n + 1)},
    (Γ ⊢ p ≡ p' ∶ ΣA;B) →
      (∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1)) (S : Tm l)
          (a a' A_1 : Tm m),
                                      ...
                                      eqM ▸ B⌈(ₛidₚ), a₁, a₁, A.refl a₁⌉ = A_1 →
                                        eqM ▸ B'⌈(ₛidₚ), a₂, a₂, A'.refl a₂⌉ = A'_1 →
                                          (Γ_1 ⬝ S ⊢ s ∶ S⌊↑ₚidₚ⌋) →
                                            Γ_1 ⬝ S ⊗ ⌈s↑⌉(Δ w/Nat.le_refl (l + 1)) ⊢ A_1⌈s↑/ₙleq⌉ ≡ A'_1⌈s↑/ₙleq⌉ type) →
                                  (∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m)
                                      (s : Tm (l + 1)) (S : Tm l) (A A' : Tm m),
                                      eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                                        eqM ▸ B⌈(ₛidₚ), a₁, a₃, p⌉ = A →
                                          eqM ▸ B'⌈(ₛidₚ), a₂, a₄, p'⌉ = A' →
                                            (Γ_1 ⬝ S ⊢ s ∶ S⌊↑ₚidₚ⌋) →
                                              Γ_1 ⬝ S ⊗ ⌈s↑⌉(Δ w/Nat.le_refl (l + 1)) ⊢ A⌈s↑/ₙleq⌉ ≡ A'⌈s↑/ₙleq⌉ type) →
                                    ∀ (m l : Nat) {leq : l + 1 ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m)
                                      (s : Tm (l + 1)) (S : Tm l) (a a' A_1 : Tm m),
                                      eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ →
                                        eqM ▸ A.j B b a₁ a₃ p = a →
...
theorem weak_substitution_unit_empty_eq :
    ∀ {n : Nat} {Γ : Ctx n},
    Γ ctx →
      (∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1)) (S : Tm l),
          eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ → (Γ_1 ⬝ S ⊢ s ∶ S⌊↑ₚidₚ⌋) → Γ_1 ⬝ S ⊗ ⌈s↑⌉(Δ w/Nat.le_refl (l + 1)) ctx) →
...
theorem weak_substitutoin_univ_nat_eq :
    ∀ {n : Nat} {Γ : Ctx n},
    Γ ctx →
      (∀ (m l : Nat) {leq : l ≤ m} (Γ_1 : Ctx l) (Δ : CtxGen (l + 1) m) (eqM : n = m) (s : Tm (l + 1)) (S : Tm l),
          eqM ▸ Γ = Γ_1 ⬝ S ⊗ Δ → (Γ_1 ⬝ S ⊢ s ∶ S⌊↑ₚidₚ⌋) → Γ_1 ⬝ S ⊗ ⌈s↑⌉(Δ w/Nat.le_refl (l + 1)) ctx) →
...
theorem weak_substitutoin_univ_iden_eq :
